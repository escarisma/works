...
INSERT INTO public.properties VALUES (7, 14.01, -210.1, -195.8, 3);
...
--
-- Name: elements symbol_uniq; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT symbol_uniq UNIQUE (symbol);
